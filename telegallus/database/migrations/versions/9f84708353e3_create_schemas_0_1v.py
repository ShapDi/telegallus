...
def upgrade() -> None:
    ...
    op.create_table('replication_chats',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('chat_tg_id', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('accounts_tg_pars',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    op.create_table('message_monitored_chat',
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('text', sa.String(), nullable=True),
    sa.Column('message_id', sa.String(), nullable=True),
    sa.Column('chat_id', sa.Uuid(), nullable=True),
    sa.ForeignKeyConstraint(['chat_id'], ['monitored_chats.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['account_tg_pars_id'], ['accounts_tg_pars.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
